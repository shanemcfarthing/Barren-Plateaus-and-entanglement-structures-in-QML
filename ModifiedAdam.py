...
class modifiedADAM(Optimizer):
    ...
    calculated during the minimization of the objective function
    ...
    def minimize(
        ...
        Returns:
            A tuple of (optimal parameters, optimal value, number of iterations, gradients).
        """
        ...
        average_gradient = 0
        for i in derivative:
            average_gradient += i/len(derivative)
        gradients[key] = average_gradient
        key += 1
    ...
    def optimize(
        ...
        point, value, nfev, grads = self.minimize(objective_function, initial_point, gradient_function)
        return point, value, nfev, grads
