...
#time how long it takes for the program to generate all of the different variational forms and then run the VQE for each
...
print("Time taken to run the parallelized section of the code was ",minutes," minutes and ",seconds," seconds")
