...
#
# NOTICE: This file contains code which has been modified from the original
# to provide a VQE which can handle an optimizer which returns the gradients.
...
class modifiedVQE(VariationalAlgorithm, MinimumEigensolver):
    """The Variational Quantum Eigensolver algorithm.
    ...
    def compute_minimum_eigenvalue(
        ...
        start_time = time()
        opt_params, opt_value, nfev, gradients, eigs = self.optimizer.optimize(
